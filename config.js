...
var config = {
    ...
    pomodoroWorkMinutes: 0.2,    // WORK SESSION: Default duration for a work session (0.2 = 12 seconds for testing)
    pomodoroBreakMinutes: 0.2,     // BREAK SESSION: Default duration for a break session (0.1 = 6 seconds for testing)
    ...
    notificationInitialDelayMinutes: 0.05, // How long to wait after browser start/install (Low for testing)
    notificationPeriodMinutes: 0.2,       // How often to check (Low for testing)
